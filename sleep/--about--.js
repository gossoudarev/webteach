...
там находится index.php и два файла index.js и time.js, 
выполняющих ту же функциональность

/etc/init/sleeper.conf
...
user@kodaktor:/var/www/lr/sleep# service sleeper start
sleeper start/running, process 17307
